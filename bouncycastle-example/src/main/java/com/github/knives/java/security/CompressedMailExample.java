...
public class CompressedMailExample {
	public static void main(String args[]) throws Exception {
		...
		MimeBodyPart comPart = gen.generate(dataPart,
				SMIMECompressedGenerator.ZLIB);

		// create the mail message
		MimeMessage mail = Utils.createMimeMessage(
				"example compressed message", comPart.getContent(),
		...
		// uncompression step
		MimeBodyPart recoveredPart = SMIMEUtil.toMimeBodyPart(compressed
				.getContent());
