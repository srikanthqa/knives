...
public class OCSPClientExample {
	public static OCSPReq generateOCSPRequest(X509Certificate issuerCert,
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i != requests.length; i++) {
			...
			System.out.println("OCSP Request to check certificate number "
