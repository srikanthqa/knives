...
public class JCEKSStoreEntryExample {
	...
	public static KeyStore createKeyStore() throws Exception {
		...
		// set the entries
		store.setEntry(
				rootCredential.getAlias(),
				new KeyStore.TrustedCertificateEntry(rootCredential
						.getCertificate()), null);
		store.setEntry(endCredential.getAlias(), new KeyStore.PrivateKeyEntry(
