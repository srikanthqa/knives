...
/**
 * a simple example that creates and processes a signed mail message with
 * multi-part contents.
 */
public class SignedMultiPartMailExample extends SignedDataProcessor {
	public static void main(String args[]) throws Exception {
		...
		MimeMultipart multiPart = SignedMailExample
				.createMultipartWithSignature(key, cert, certsAndCRLs, bodyPart);

		// create the mail message
		MimeMessage body = Utils.createMimeMessage("example signed message",
