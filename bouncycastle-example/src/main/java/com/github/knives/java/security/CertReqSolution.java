...
public class CertReqSolution {
	public static void main(String[] args) throws Exception {
		...
		// parse the request
		PemReader pRd = new PemReader(new InputStreamReader(
				new FileInputStream("pkcs10.req")));

		PKCS10CertificationRequest request = (PKCS10CertificationRequest) pRd
				.readObject();
		...
		// provide some basic extensions and mark the certificate as appropriate
		// for signing and encipherment
		...
		// create the chain
		List chain = Arrays.asList(new Certificate[] {
				certGen.generateX509Certificate(
						interCredential.getPrivateKey(), "BC"),
