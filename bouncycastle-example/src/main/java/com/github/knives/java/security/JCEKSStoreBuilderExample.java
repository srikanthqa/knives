...
/**
 * Basic example of use of KeyStore.Builder to create an object that can be used
	...
	public static void main(String[] args) throws Exception {
		...
		KeyStore.Builder builder = KeyStore.Builder.newInstance(store,
				new KeyStore.PasswordProtection(
						JCEKSStoreEntryExample.keyPassword));

		// use the builder to recover the KeyStore and obtain the key
		store = builder.getKeyStore();

		KeyStore.ProtectionParameter param = builder
				.getProtectionParameter(Utils.END_ENTITY_ALIAS);
