...
public class InlineIvCBCExample {
	public static void main(String[] args) throws Exception {
		...
		System.out.println("plain : "
				+ Utils.toHex(plainText, plainText.length) + " bytes: "
				+ plainText.length);
	}
}
