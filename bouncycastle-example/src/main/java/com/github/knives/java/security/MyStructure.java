 ...
 * 
 */
public class MyStructure extends ASN1Primitive {
	 ...
	 */
	public MyStructure(int version, Date created, byte[] baseData,
			String extraData, String commentData) {
