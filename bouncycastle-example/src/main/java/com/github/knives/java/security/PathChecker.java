...
class PathChecker extends PKIXCertPathChecker {
	...
	public PathChecker(KeyPair responderPair, X509Certificate caCert,
	...
	public void check(Certificate cert, Collection extensions)
		...
		try {
			String message = OCSPResponderExample.getStatusMessage(
					responderPair, caCert, revokedSerialNumber, x509Cert);
